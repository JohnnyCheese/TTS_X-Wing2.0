...
-- Toggle on/off
Display.buttons.main.toggleActive = { position = { -2.2, 0.2, 1 }, width = 1500, height = 400, font_size = 180, click_function =
'Click_ToggleActive', function_owner = self }
...
-- Toggle colors lock
Display.buttons.main.toggleColorLock = { position = { -2.2, 0.2, 0 }, width = 1500, height = 400, font_size = 180, click_function =
'Click_ToggleColorLock', function_owner = self }
...
Display.buttons.main.togglePermissions = { position = { -2.2, 0.2, -1 }, width = 1500, height = 400, font_size = 180, click_function =
'Click_TogglePermissions', function_owner = self }
...
Display.buttons.whitelist.updateWhitelist = { position = { -2.2, 0.2, -1 }, color = { 0.3, 0.3, 1 }, width = 1200, height = 280, font_size = 120, click_function =
'Click_UpdateWhitelist', label = 'Update whitelist', function_owner = self }
...
-- Clear whitelist
Display.buttons.whitelist.clearWhitelist = { position = { -2.2, 0.2, -1 * (1 / 3) }, color = { 0.3, 0.3, 1 }, width = 1200, height = 280, font_size = 120, click_function =
'Click_ClearWhitelist', label = 'Clear whitelist', function_owner = self }
...
Display.buttons.whitelist.printWhitelist = { position = { -2.2, 0.2, 1 / 3 }, color = { 0.3, 0.3, 1 }, width = 1200, height = 280, font_size = 120, click_function =
'Click_PrintWhitelist', label = 'Print whitelist', function_owner = self }
...
Display.buttons.whitelist.helpWhitelist = { position = { -2.2, 0.2, 1 }, color = { 0.3, 0.3, 1 }, width = 1200, height = 280, font_size = 120, click_function =
'Click_HelpWhitelist', label = 'How to use?', function_owner = self }
