...
-- Setup function to configure LuaUnit with TTSOutput
local function setup(luaunitModule)
    -- luaunitModule.LuaUnit.setOutputType('custom', TTSOutput)
    luaunitModule.LuaUnit.outputType = TTSOutput
end

return { setup = setup, TTSOutput = TTSOutput }
