-- Bundled by luabundle {"rootModuleName":"Saxton-Cloak.f666c8.lua","version":"1.6.0"}
...
__bundle_register("Cloak.f6c8b9.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
require("Token.Cloak")

end)
__bundle_register("Token.Cloak", function(require, _LOADED, __bundle_register, __bundle_modules)
-- ~~~~~~
...
return __bundle_require("Saxton-Cloak.f666c8.lua")