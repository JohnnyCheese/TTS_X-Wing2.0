...
do
    ...
    epic.elements      = {
        ...
        ['Board Edge L']           = { pos = { -37.05, 0.8, 0.00 }, rot = { 0.00, 0.00, 0.00 }, scale = { 0.5, 0.5, 16.75 }, int = false },
        ['Board Edge R']           = { pos = { 31.05, 0.80, 0.00 }, rot = { 0.00, 0.00, 0.00 }, scale = { 0.5, 0.5, 16.75 }, int = false },
