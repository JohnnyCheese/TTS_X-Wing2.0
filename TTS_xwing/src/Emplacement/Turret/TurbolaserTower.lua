...
Data = { Size = "objective", initiative = 0, faction = "neutral" }
...
local function ensureEmplacementTags()
    for _, tag in ipairs({ "Targetable", "TargetableRemote", "Emplacement" }) do
        self.addTag(tag)
    end
end
